...
public class App
{
    ...
    {
        String [] templates = {"The password '%s' is a very weak password.", "The password '%s' is a weak password.", "The password '%s' is a strong password.", "The password '%s' is a very strong password."};
