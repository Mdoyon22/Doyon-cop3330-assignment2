...
public class App
{
    ...
    public static String validateInput(String fname, String lname, String zipcode, String id) {
        ...
        String [] existenceTemplates = {"The first name must be filled in.\n", "The last name must be filled in.\n"};

        String [] invalidTemplates = {"The first name must be at least 2 characters long.\n", "The last name must be at least 2 characters long.\n", "The employee ID must be in the format of ",  id + ".\n" + "The zipcode must be a 5 digit number.\n"};
